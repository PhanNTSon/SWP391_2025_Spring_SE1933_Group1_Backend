...
// @Test
// @DisplayName("getGameDetailsById - Should return GameDetailDTO when game
// exists")
...
// @Test
// @DisplayName("getGameDetailsById - Should throw EntityNotFoundException when
// game does not exist")
...
// @Test
// @DisplayName("searchGamesByName - Should return a list of games when term
// matches")
...
// @Test
// @DisplayName("searchGamesByName - Should return empty list for null or empty
// term")
...
// @Test
// @DisplayName("searchGamesByName - Should return empty list when no games
// match")
// void searchGamesByName_whenNoGamesMatch_shouldReturnEmptyList() {
// String searchTerm = "Haha";
// Pageable pageable = PageRequest.of(0, 5);
// when(gameRepository.findByNameContainingIgnoreCase(searchTerm,
...
// @Test
// @DisplayName("findGamesByCriteria - Should return games matching all
// criteria")
...
// Page<GameBasicDTO> result = gameService.findGamesByCriteria("Test", new
// BigDecimal("50.00"),
...
// @Test
// @DisplayName("findGamesByCriteria - Should return empty page when no games
// match")
// @SuppressWarnings("unchecked")
...
// Page<GameBasicDTO> result = gameService.findGamesByCriteria("NonExistent",
